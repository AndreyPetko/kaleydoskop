...
@section('mobile')
    ...
    <div class="mobile-slider">
        <div class="mobile-slider-image">
            <img src="{{ url('site/images/4d5bbf6752863b73c9dc5077dam3--materialy-dlya-tvorchestva-muline-fabriki-im.png') }}"
                 alt="">
        </div>
        <div class="mobile-slider-text">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus fuga assumenda vero in necessitatibus
            vel, nesciunt ex autem deleniti eligendi.
        </div>
    </div>
