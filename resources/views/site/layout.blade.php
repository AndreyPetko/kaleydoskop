...
<div class="wrapper">
    ...
    <div class="main-menu">
        ...
        <a href="/oplata-dostavka">
            <div class="main-menu-item main-menu-item-sm @if($_SERVER['REQUEST_URI'] =='/oplata-dostavka') main-menu-active @endif">
                Оплата и доставка
            </div>
        </a>
        <a href="/about"></area>
        ...
        <a href="/wholesalers">
            <div class="main-menu-item main-menu-item-sm @if($_SERVER['REQUEST_URI'] =='/wholesalers') main-menu-active @endif">
                Оптовикам
            </div>
        </a>
        <a href="/articles">
            <div class="main-menu-item @if($_SERVER['REQUEST_URI'] =='/articles') main-menu-active @endif">Статьи</div>
        </a>
