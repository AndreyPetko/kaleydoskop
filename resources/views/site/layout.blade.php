...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-110159845-1"></script>
    <script>
...
<body>
    ...
    <div class="feedback-block" id="sendmail-block">
        <div class="fast-order-title">
            ...
            <div class="intake-close fr" id="sendmail-close"><img src="{{ url('site/images/close-photo.png') }}" alt="">
            </div>
        </div>
        ...
        <form method="POST" action="/add-sendmail">
            ...
            <div class="fast-order-form-row">
                ...
                <div class="fast-order-input fl"><input type="text" name="email"
                    @if(Auth::check()) value="{{Auth::user()->email}}" @endif></div>
                </div>
        ...
        <div class="success-register" id="register-block">
            <div class="fast-order-title">
                ...
                <div class="intake-close fr" id="register-close"><img src="{{ url('site/images/close-photo.png') }}" alt="">
                </div>
            </div>
            <div class="fast-order-text">
        ...
        <div class="success-register" id="sub-block">
            <div class="fast-order-title">
                ...
                <div class="intake-close fr" id="sub-close"><img src="{{ url('site/images/close-photo.png') }}" alt="">
                </div>
            </div>
            <div class="fast-order-text">
        ...
        <div class="success-register" id="feedback-res">
            <div class="fast-order-title">
                ...
                <div class="intake-close fr" id="feedback-res-close"><img src="{{ url('site/images/close-photo.png') }}"
                  alt=""></div>
              </div>
              <div class="fast-order-text">
        ...
        <div class="success-register" id="callback-res">
            <div class="fast-order-title">
                <div class="fast-order-title fl">Обратная связь</div>
                <div class="intake-close fr" id="callback-res-close"><img src="{{ url('site/images/close-photo.png') }}"
                  alt=""></div>
              </div>
              <div class="fast-order-text">
        ...
        <div class="feedback-block" id="feedback-block">
            <div class="fast-order-title">
                <div class="fast-order-title fl">Обратная связь</div>
                <div class="intake-close fr" id="feedback-close"><img src="{{ url('site/images/close-photo.png') }}" alt="">
                </div>
            </div>
            <div class="fast-order-text">
            ...
            <form method="POST" action="/send-feedback">
                ...
                <div class="fast-order-form-row">
                    ...
                    <div class="fast-order-input fl"><input type="text" name="name"
                        @if(Auth::check()) value="{{Auth::user()->name}}" @endif></div>
                    </div>
                    <div class="fast-order-form-row">
                ...
                <div class="feedback-block" id="callback-block">
                    <div class="fast-order-title">
                        ...
                        <div class="intake-close fr" id="callback-close"><img src="{{ url('site/images/close-photo.png') }}" alt="">
                        </div>
                    </div>
                    <div class="fast-order-text">
                    ...
                    <form method="POST" action="/add-callback" id="callback-form">
                        ...
                        <div class="fast-order-form-row">
                            ...
                            <div class="fast-order-form-row">
                                ...
                                <div class="fast-order-input fl"><input type="text" class="phone" name="phone"
                                    @if(Auth::check()) value="{{Auth::user()->phone}}" @endif></div>
                                </div>
                                <div class="fast-order-form-row">
                                    <div class="fast-order-submit fr">
                                        <input type="submit" value="Подтвердить">
                        ...
                        <a href="/new-products">
                            <div class="main-menu-item  @if($_SERVER['REQUEST_URI'] =='/new-products') main-menu-active @endif">
                                Новинки
                            </div>
                        </a>
                        <a href="http://www.kaleydoskop-vishivki.com.ua/#recommend" >
                            <div class="main-menu-item main-menu-item-sm">
                                Рекомендуем
                            </div>
                        </a>
                        <a href="/contacts">
                            <div class="main-menu-item @if($_SERVER['REQUEST_URI'] =='/contacts') main-menu-active @endif">Контакты
                            </div>
                        </a>
                        <a href="/oplata-dostavka">
                            <div class="main-menu-item  @if($_SERVER['REQUEST_URI'] =='/oplata-dostavka') main-menu-active @endif">
                                Оплата и доставка
                            </div>
                        </a>
                        <a href="/about">
                            <div class="main-menu-item main-menu-item-sm @if($_SERVER['REQUEST_URI'] == '/about') main-menu-active @endif">
                                О компании
                            </div>
                        </a>
                        <a href="/wholesalers">
                            <div class="main-menu-item  @if($_SERVER['REQUEST_URI'] =='/wholesalers') main-menu-active @endif">
                                Оптовикам
                            </div>
                        </a>
                        <a href="/articles">
                            <div class="main-menu-item main-menu-item-sm @if($_SERVER['REQUEST_URI'] =='/articles') main-menu-active @endif">Статьи</div>
                        </a>
        ...
        <div class="footer-wrapper">
            ...
            <div class="footer-banners">
                ...
                <script type="text/javascript" language="javascript">
                    ...
                    <noscript>
                        <a href="http://www.bigmir.net/" target="_blank"><img src="http://c.bigmir.net/?v16900002&s16900002&t2"
                          width="88" height="31" alt="bigmir)net TOP 100"
                          title="bigmir)net TOP 100" border="0"/></a>
                      </noscript>
                      <a href="http://www.i.ua/" target="_blank" onclick="this.href='http://i.ua/r.php?144160';"
                      title="Rated by I.UA">
                      <script type="text/javascript" language="javascript">
            ...
            src="http://counter.rambler.ru/top100.jcn?2756718"></script>
            <noscript>
