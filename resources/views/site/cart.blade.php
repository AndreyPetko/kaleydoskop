            ...
            @if(!Auth::check())
                <form method="POST" action="/login">
                    ...
                    <div class="cart-tologin-group">
                        ...
                        <div id="cart-to-login">Войти</div>
                    </div>
        ...
        <div class="category-products-content fl">
            ...
            @if($products)
               ...
               <img src="{{ url('/site/images/icon-loop.png') }}">
                            ...
                            <input type="text" name="product[{{$product->id}}]" value="{{$product->count}}"
                                   data-productid="{{$product->id}}" class="count-inputs"
                                   data-price="{{$product->price}}">
                            <div class="cart-product-price-total">{{$product->price*$product->count}} грн</div>
                            <div class="cart-list-item-delete cart-page-delete fl" data-productid="{{$product->id}}"
                                 data-totalprice="{{$product->price * $product->count}}"><img
                                        src="{{ url('site/images/MergedLayers4.png') }}" alt=""></div>
                        </div>
                    @endforeach
                    @else
                        <div class="cart-products">
           ...
           @if($total)
                        ...
                        <div class="cart-pay-del fl">
                            ...
                            <div class="cart-pay-del-cont">
                                ...
                                @endif
                                <input type="checkbox" name="delivery[]" value="nova poshta">
                                <p>Новой почтой</p>
                                @if(!Auth::check() || (Auth::user()->role == 'retail' || Auth::user()->role == 'admin'))
                        ...
                        <div class="cart-pay-del fl">
                            ...
                            <div class="cart-pay-del-cont payment-checboxes">
                                <input type="checkbox" name="payment[]" disabled value="nal">
            ...
            <form action="/orders/add" method="POST" id="order-form">
               ...
               <img src="{{ url('/site/images/icon-loop.png') }}">
                                        ...
                                        <input type="text" name="product[{{$product->id}}]" value="{{$product->count}}"
                                               data-productid="{{$product->id}}" class="count-inputs"
                                               data-price="{{$product->price}}">
                                        <div class="cart-product-price-total">{{$product->price*$product->count}}грн
                                        </div>
                                        <div class="cart-list-item-delete cart-page-delete fl"
           ...
           @if($total)
                                    ...
                                    <div class="">
                                        ...
                                        @if(!Auth::check())
                                            <div class="cart-tologin-group">
                                                <p>Уже есть аккаунт?</p>
                                                <div id="cart-to-login-mobile">Войти</div>
                                            </div>
                                            <div id="login-in-cart-mobile">
                                                <div class="cart-info-input">
                                                    <p>Email*</p>
                                    ...
                                    <div class="cart-pay-del-mob fl">
                                        ...
                                        <div class="cart-pay-del-cont">
                                            ...
                                            <p>Самовывоз</p>
                                            @if(!Auth::check() || (Auth::user()->role == 'retail' || Auth::user()->role == 'admin'))
                                                <input type="checkbox" name="delivery[]" value="kuryer"><p>Курьером по
                                                    Киеву</p>
                                            @endif
                                            <input type="checkbox" name="delivery[]" value="nova poshta">
                                            <p>Новой почтой</p>
                                            @if(!Auth::check() || (Auth::user()->role == 'retail' || Auth::user()->role == 'admin'))
                                                <input type="checkbox" name="delivery[]" value="ukr poshta"><p>
                                                    Укрпочтой</p>
                                            @endif
